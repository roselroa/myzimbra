...
STARTSERVERS=yes
SYSTEMMEMORY=1.0
TRAINSAHAM=ham.yywuj7xba@${DOMAIN}
TRAINSASPAM=spam.khwylrq8w@${DOMAIN}
UPGRADE=yes
USESPELL=yes
VERSIONUPDATECHECKS=TRUE
VIRUSQUARANTINE=virus-quarantine.klyq4es0jb@${DOMAIN}
ZIMBRA_REQ_SECURITY=yes
ldap_bes_searcher_password=yxkZ2A_R
ldap_dit_base_dn_config=cn=zimbra
ldap_nginx_password=yxkZ2A_R
mailboxd_directory=/opt/zimbra/mailboxd
mailboxd_keystore=/opt/zimbra/mailboxd/etc/keystore
mailboxd_keystore_password=3l1IVRI6
